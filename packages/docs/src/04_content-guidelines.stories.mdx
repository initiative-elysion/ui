...
<Meta title="Concepts/Content &amp; Language Guideline" />

These are our template's recommeneded conventions, adjust to these to fit your needs. Some conventions are examples and are not demonstrated in this template. Please keep these updated with any other good conventions.
...
Prismic does not version custom types. To be safe and track changes, it's a good idea to keep manual copies in `prismic-custom-types`. Each file should be named in the format `custom_type_name.json`.
...
- Prismic does _not_ support nested lists in fragments
...
1. **Content Modeling:**
   - [Setting up and retrieving hierarchical content](https://user-guides.prismic.io/en/articles/1069971-setting-up-and-retrieving-hierarchical-content)
   - _Guide to a Complex Model_ implements [UserGuide](https://user-guides.prismic.io/en/articles/868753-sample-ecommerce-site-with-snipcart-in-node-js):
     - [General LandingPage](https://prismic.io/concepts/content-modeling/general-landing-page) vs. [Marketing Landingpage](https://prismic.io/concepts/content-modeling/homepage-marketing-corporate-website)
     - [Homepage](https://prismic.io/concepts/content-modeling/example-of-a-ecommerce-homepage) Example
     - [Navigation](https://prismic.io/concepts/content-modeling/e-commerce-navigation-menu-ecommerce)
     - [Product=Artist/Kollektiv/Festival](https://prismic.io/concepts/content-modeling/e-commerce-product-pages)
2. **Templating:**
   - [Prepare for all kinds of Images](https://prismic.io/docs/technologies/rendering-the-image-field-reactjs#retrieve-the-image-url--alt-text)
   - Templating the [Date](https://prismic.io/docs/technologies/templating-date-field) & [Color](https://prismic.io/docs/technologies/templating-color-field)fields - output rainbox dates
   - [fetchLinks](https://prismic.io/docs/technologies/fetch-linked-document-fields-reactjs)
3. **Content Authoring:**
   - [Previews & the Prismic Toolbar](https://prismic.io/docs/technologies/previews-and-the-prismic-toolbar-reactjs)
   - [custom-types-by-existing-prismic-repository](https://community.prismic.io/t/custom-types-by-existing-prismic-repository/4457/3)
